...
.defines(function(){ "use strict";
    ig.SimpleCamera = ig.Class.extend({
        ...
        init: function(map) {
            ...
            this.map = ig.game.getMapByName(map);
        ...
        getMinMax: function() {
            ...
            this.x.max = (this.map.pxWidth - ig.system.width - this.offset.x.max);
            this.y.max = (this.map.pxHeight - ig.system.height - this.offset.y.max);
