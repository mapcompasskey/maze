...
.defines(function() {
    PlayerShader = ig.Entity.extend({
        ...
        tilesShader: new ig.Image('media/shader3.png'),
        ...
        redrawMap: function() {
            ...
            if (this.entity)
            {
                ...
                this.fillGradientCircle(entity.x, entity.y);
                this.plotCircle(entity.x, entity.y);
            }
        ...
        resetMaps: function () {
            ...
            for (i = 0; i < this.gradientMapTiles.length; i++)
            {
                ...
                this.gradientMap.data[y][x] = this.darkestTile;
            }
        ...
        fillGradientCircle: function(x0, y0) {
        ...
        setLightTile: function(x, y) {
            ...
            // update tile
            if (ig.game.shaderMode == 'gradient')
            {
