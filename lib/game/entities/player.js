    ...
    EntityPlayer = ig.Entity.extend({
        ...
        isMoving: function() {
            ...
            else
            {
                ...
                // moving left
                if (this.movingLeft && ! this.getTile(-1, 0))
                {
                ...
                // moving right
                else if (this.movingRight && ! this.getTile(1, 0))
                {
                    this.vel.x += this.speed;
                    this.destination.x = (this.pos.x + ig.game.tileSize);
                    this.moving = true;
                ...
                // moving up
                else if (this.movingUp && ! this.getTile(0, -1))
                {
                ...
                // moving down
                else if (this.movingDown && ! this.getTile(0, 1))
                {
                    this.vel.y += this.speed;
                    this.destination.y = (this.pos.y + ig.game.tileSize);
                    this.moving = true;
