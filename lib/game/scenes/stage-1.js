...
.defines(function() {
    ...
    Stage1 = ig.Game.extend({
        ...
        draw: function() {
            ...
            this.font.draw('Arrow Keys to Move | Q key to toggle lights', 5, 5, ig.Font.ALIGN.LEFT);
            this.font.draw(this.turnCounter, (ig.system.width - 5), 5, ig.Font.ALIGN.RIGHT);
        },
