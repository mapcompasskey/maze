...
.defines(function() {
    ...
    Stage1 = ig.Game.extend({
        ...
        update: function() {
            ...
            // update shader mode
            if (ig.input.pressed('mode'))
            {
                this.gradientMode = !this.gradientMode;
                this.playerShader.redrawing = true;
                this.minotaurShader.redrawing = true;
                this.minotaurVision.redrawing = true;
            }
        ...
        draw: function() {
            ...
            this.minotaurShader.draw(this.gradientMode);
            this.minotaurVision.draw(this.gradientMode);
            ...
            // draw player shader
            this.playerShader.draw(this.gradientMode);
            
            this.font.draw('Arrow Keys to Move | M to change Mode', (2 - ig.game.screen.x), (2 - ig.game.screen.y), ig.Font.ALIGN.LEFT);
        ...
        loadLevel: function(data) {
            ...
            this.playerShader = new PlayerShader(this.tilesName, this.player);
            
            // add minotaur
            this.minotaur = ig.game.spawnEntity(EntityMinotaur, (15 * ig.game.tileSize), (1 * ig.game.tileSize));
            this.minotaurShader = new MinotaurShader(this.tilesName, this.minotaur, 'shader');
            this.minotaurVision = new MinotaurShader(this.tilesName, this.minotaur, 'vision');
