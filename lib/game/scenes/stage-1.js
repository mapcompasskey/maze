    ...
    Stage1 = ig.Game.extend({
        ...
        update: function() {
            ...
            if (this.isGameover)
            {
                ...
                {
                    this.gameoverTimer = new ig.Timer(this.gameoverTime);
                }
            }
        ...
        loadLevel: function(data) {
            ...
            if (this.namedEntities)
            {
                ...
                if (this.namedEntities.spawnPlayer)
                {
                    ...
                    xPos = 49 * this.tileSize;
                    yPos = 49 * this.tileSize;
                ...
                this.minotaurShader = new EntityMinotaurShader(this.tilesName, 'shader');
                this.minotaurVision = new EntityMinotaurShader(this.tilesName, 'vision');
        ...
        stateGameover: function() {
            ...
            ig.system.setGame(ScreenGameover);
        ...
        stageComplete: function() {
            ...
            ig.system.setGame(ScreenComplete);
