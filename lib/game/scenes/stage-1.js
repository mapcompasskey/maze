    ...
    Stage1 = ig.Game.extend({
        ...
        loadLevel: function(data) {
            ...
            if (this.showTileShader)
            {
                ...
                //this.tileShader.losShade = false;
                //this.tileShader.shadeCircle = false;
                //this.tileShader.fillCircle = true;
                
                
                this.player.lightOptions = {};
                this.player.lightOptions.innerRadius = 0;
                this.player.lightOptions.outerRadius = 4;
